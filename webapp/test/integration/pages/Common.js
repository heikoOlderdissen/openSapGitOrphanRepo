sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/hettich/dit/tutorial/worklistAppOdata/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#WorklistOdata-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#WorklistOdata-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("com.hettich.dit.tutorial.worklistAppOdata.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/hettich/dit/tutorial/worklistAppOdata/localService/mockserver"], function (mockserver) {
